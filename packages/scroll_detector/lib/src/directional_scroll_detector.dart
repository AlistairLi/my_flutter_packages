...
/// 带滚动方向的滚动监听Widget
/// 🔶[UNTESTED]
class DirectionalScrollDetector extends StatefulWidget {
  final Widget child;
  ...
  const DirectionalScrollDetector({
    super.key,
    required this.child,
  ...
  @override
  State<DirectionalScrollDetector> createState() =>
      _DirectionalScrollDetectorState();
}

class _DirectionalScrollDetectorState extends State<DirectionalScrollDetector> {
